...
const (
	...
	// Number of numas
	ResourceNuma ResourceName = "pod.alpha.kubernetes.io/opaque-int-resource-numa"
	// Number of cpusets
	ResourceCpuSet ResourceName = "pod.alpha.kubernetes.io/opaque-int-resource-cpuset"
)
