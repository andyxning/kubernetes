...
type cpuSetManagerStub struct{}

func (cms *cpuSetManagerStub) Start() error {
	return nil
}

func (cms *cpuSetManagerStub) CapacityNuma() v1.ResourceList {
	return nil
}

func (cms *cpuSetManagerStub) CapacityCpuSet() v1.ResourceList {
	return nil
}
